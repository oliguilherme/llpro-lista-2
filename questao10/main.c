...
int main() {
    ...
    int min_total_chegada, min_total_partida, diferenca_min, diferenca_hora, min_negativo, hora_negativa;
    float custo;
    ...
    if (diferenca_min < 0) {
        min_negativo = min_total_partida + (24 * 60) - min_total_chegada;
        diferenca_min = min_negativo * (-1); 
        diferenca_hora *= -1;  
    }
